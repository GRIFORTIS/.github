...
This repository provides **organization-wide** GitHub community health defaults for the `GRIFORTIS` org (Code of Conduct, Security policy, Contributing guidelines, Issue templates, and PR template).
